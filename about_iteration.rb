...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Like the JavaScript reduce, does a running operation, carrying forward the resulting value, given a starting value
  end
  ...
  #   end
  #
  # Why did we do it that way instead of the following? To isolate errors to this specific block
  #
